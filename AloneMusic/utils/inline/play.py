...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="➕ 𝗕𝗲𝗻𝗶 𝗘𝗸𝗹𝗲 ",  # Beni ekle butonu
                url=f"https://t.me/{app.username}?startgroup=true",  # Botu ekleme linki
            ),
            InlineKeyboardButton(
                text="💌 𝗞𝗮𝗻𝗮𝗹",  # Kanal ekle butonu
                url=f"https://t.me/The_Team_Kumsal",  # Kanal linki
            ),
        ],
        [
            InlineKeyboardButton(
        ...
        [
            ...
            InlineKeyboardButton(
                text="⏩",  # Oynat butonu
                callback_data=f"ADMIN skip|{chat_id}",  # Devam et komutu
            ),
        ]
    ]
    return buttons
