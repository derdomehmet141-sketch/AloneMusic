...
LOGGER_ID = int(getenv("LOGGER_ID", 0))  # Logger kanal ID'si
...
# Diğer gereksiz değişkenler (varsa)
...
# Görseller
START_IMG_URL = getenv("START_IMG_URL", "https://ibb.co/0jsDgHSj")
PING_IMG_URL = getenv("PING_IMG_URL", "https://ibb.co/0jsDgHSj")
...
# Süreyi saniyeye çevirme fonksiyonu
...
# URL kontrolü (doğru formatta olduklarından emin olma)
if SUPPORT_CHANNEL:
